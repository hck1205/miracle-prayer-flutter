...
echo Building Flutter web app for local login testing...
...
echo Starting local web server at http://%MIRACLE_PRAYER_WEB_HOST%:%MIRACLE_PRAYER_WEB_PORT%
"C:\Program Files\nodejs\node.exe" serve-build.js
